...
public class Code03_SquareRoot {
    public static int MAN = 100001;
    public static long[] arr = new long[MAN];
    public static long[] sum = new long[MAN << 2];
    public static long[] max = new long[MAN << 2];
    ...
    public static void sqrt(int jobl, int jobr, int l, int r, int i) {
        if (l == r) {
            ...
            if (jobl > mid && jobl <= mid + 1 && max[i << 1 | 1] > 1) {
